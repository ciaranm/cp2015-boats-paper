...
\begin{align}
    ...
    &\begin{alignedat}{3}
    &\hspace*{1em} \state[{i}] = \FIRST &\ &\Leftrightarrow&&\ \timeSlot[{i \cdot m}] \geq 0 \\
    &\hspace*{1em} \state[{i}] = \MID   &\ &\Leftrightarrow&&\ \exists j \in \{i\cdot m{+}1 \nldots i \cdot m{+}m{-}2\} : \timeSlot[{j}] \geq 0 \\
    &\hspace*{1em} \state[{i}] = \LAST  &\ &\Leftrightarrow&&\ \timeSlot[{(i{+}1)m {-} 1}] \geq 0 \\
    &\hspace*{1em} \state[{i}] = \BYE   &\ &\Leftrightarrow&&\ \forall j \in \{i \cdot m \nldots m \cdot (i{+}1){-}1\} : \timeSlot[j] = {-}1 \\
    &\hspace*{1em} \state[{i}] = \END   &\ &\Leftrightarrow&&\ \forall j \in \{i \cdot m \nldots m \cdot (i{+}1){-}1\} : \timeSlot[j] = {-}2
    \end{alignedat} \nonumber \\
    ...
    & \totalChanges = \textstyle\sum_{i=0}^{f{-}2} \change[{i}] \label{C5} \tag{C5}
\end{align}
...
\begin{align}
    ...
    & \totalBoatChanges = \textstyle\sum_{i=0}^{n{-}1} \sigma[{i}].\totalChanges  \label{V8} \tag{V8} \\
...
is a deterministic finite automata (DFA) constraint \cite{Pesant04}.  This
constraint also ensures that if a skipper has finished his matches in flight
$i$ (i.e.\ $\END$) then he has finished his matches in flight $i+1$ (and so
on).
