...
\begin{figure}[tb]
    ...
    \begin{scope}[every node/.style={minimum size=2em,inner sep=1}, xshift=-1cm]
        ...
        \draw [<-, >=latex, thick] (DFAL) to node [xshift=0.6em] { $\star$ } (DFAB);
...
\section{Discussion}
It was anticipated that this problem would be easy to model. This na{\"\i}vety was due to the use of the
term ``round-robin'' for these schedules, leading us to believe that we could use some of the models
already in the literature \cite{trick2002,trick2008,henz2004}. This na{\"\i}vety slowly dissolved as
...
team's communications, it was also a constraint (the \emph{regular} constraint).
