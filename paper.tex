...
finished all matches in flight $i+1$ (and so on). Note that when we have as many
boats as skippers, the directed edge $(\BYE,\LAST)$ (marked $\star$) becomes bidirectional.
